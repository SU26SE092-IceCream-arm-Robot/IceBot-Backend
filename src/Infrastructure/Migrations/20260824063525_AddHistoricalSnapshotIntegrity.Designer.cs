...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260824063525_AddHistoricalSnapshotIntegrity")]
    partial class AddHistoricalSnapshotIntegrity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Catalog.Entities.CatalogImageCleanup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CatalogImageAssetId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PublicIdSnapshot")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("CatalogImageAssetId");

                    b.HasIndex("CompletedAt", "NextAttemptAt");

                    b.ToTable("CatalogImageCleanups", (string)null);
                });

            modelBuilder.Entity("Domain.Catalog.Entities.CatalogImageOperationReplay", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ScopeKey", "OwnerType", "OwnerId", "Operation", "IdempotencyKey")
                        .IsUnique();

                    b.ToTable("CatalogImageOperationReplays", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Orders.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<int?>("PreparationTimeSecondsSnapshot")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Payments.Entities.PaymentProviderExchange", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProviderOrderCodeSnapshot")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasIndex("PaymentTransactionId", "Operation")
                        .IsUnique()
                        .HasFilter("\"Status\" = 1");

                    b.HasIndex("PaymentTransactionId", "StartedAt");

                    b.HasIndex("PaymentTransactionId", "Operation", "AttemptNumber")
                        .IsUnique();

                    b.ToTable("PaymentProviderExchanges", null, t =>
                        {
                            t.HasCheckConstraint("CK_PaymentProviderExchanges_AttemptNumber_Positive", "\"AttemptNumber\" > 0");

                            t.HasCheckConstraint("CK_PaymentProviderExchanges_CompletionAfterStart", "\"CompletedAt\" IS NULL OR \"CompletedAt\" >= \"StartedAt\"");

                            t.HasCheckConstraint("CK_PaymentProviderExchanges_HttpStatusCode_Valid", "\"HttpStatusCode\" IS NULL OR \"HttpStatusCode\" BETWEEN 100 AND 599");

                            t.HasCheckConstraint("CK_PaymentProviderExchanges_Lifecycle", "(\"Status\" = 1 AND \"Outcome\" IS NULL AND \"CompletedAt\" IS NULL) OR (\"Status\" = 2 AND \"Outcome\" IS NOT NULL AND \"CompletedAt\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_PaymentProviderExchanges_RequestPayload_Bounded", "\"RequestPayloadJson\" IS NULL OR octet_length(\"RequestPayloadJson\"::text) <= 262144");

                            t.HasCheckConstraint("CK_PaymentProviderExchanges_ResponsePayload_Bounded", "\"ResponsePayloadJson\" IS NULL OR octet_length(\"ResponsePayloadJson\"::text) <= 262144");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Catalog.Entities.CatalogImageCleanup", b =>
                {
                    b.HasOne("Domain.Catalog.Entities.CatalogImageAsset", "CatalogImageAsset")
                        .WithMany()
                        .HasForeignKey("CatalogImageAssetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CatalogImageAsset");
                });
