...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260701091611_AddEdgeRuntimeOperationsAndReadiness")]
    partial class AddEdgeRuntimeOperationsAndReadiness
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Devices.ExecutionEndpoints.ExecutionEndpointCapabilityProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Devices.ExecutionEndpoints.ExecutionEndpointReadinessProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.ProductionConfiguration.Entities.KioskConfigurationDeployment", b =>
                {
                    ...
                    b.HasIndex("ConfigurationReleaseId");
            ...
            modelBuilder.Entity("Domain.ProductionExecution.Projections.ProductionExecutionRecord", b =>
                {
                    ...
                    b.HasIndex("SourceCommandId")
                        .IsUnique()
                        .HasFilter("\"SourceProductionJobId\" IS NULL");

                    b.HasIndex("SourceCommandId", "SourceProductionJobId")
                        .IsUnique()
                        .HasFilter("\"SourceProductionJobId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Devices.ExecutionEndpoints.ExecutionEndpointCapabilityProjection", b =>
                {
                    b.HasOne("Domain.Devices.ExecutionEndpoints.ExecutionEndpointReadinessProjection", "ReadinessProjection")
            ...
            modelBuilder.Entity("Domain.Devices.ExecutionEndpoints.ExecutionEndpointReadinessProjection", b =>
                {
                    b.HasOne("Domain.Devices.ExecutionEndpoints.KioskExecutionEndpoint", "KioskExecutionEndpoint")
                        .WithOne("ReadinessProjection")
                        .HasForeignKey("Domain.Devices.ExecutionEndpoints.ExecutionEndpointReadinessProjection", "KioskExecutionEndpointId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
