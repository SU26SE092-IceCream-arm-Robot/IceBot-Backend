...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260629021939_AddRobotArtifactTemplates")]
    partial class AddRobotArtifactTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.DeviceEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.ExecutionEndpointCredentialBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.ExecutionEndpointRequestNonce", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.ExecutionEndpointSupportedRobotTarget", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.KioskExecutionEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Id", "KioskId", "FullEdgeRuntimeId")
                        .IsUnique()
                        .HasFilter("\"FullEdgeRuntimeId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.KioskHeartbeat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.ProductionConfiguration.Entities.KioskConfigurationDeployment", b =>
                {
                    ...
                    b.HasIndex("KioskExecutionEndpointId", "KioskId", "EdgeRuntimeId");
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.ExecutionEndpointCredentialBinding", b =>
                {
                    b.HasOne("Domain.Devices.Catalog.KioskExecutionEndpoint", "KioskExecutionEndpoint")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Devices.Catalog.KioskExecutionEndpoint", b =>
                {
                    b.HasOne("Domain.Devices.Catalog.ExecutionEndpointCredentialBinding", "CredentialBinding")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Operations.Entities.MaintenanceTicket", b =>
                {
                    ...
                    b.HasOne("Domain.Devices.Catalog.DeviceEvent", "DeviceEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.ProductionConfiguration.Entities.KioskConfigurationDeployment", b =>
                {
                    ...
                    b.HasOne("Domain.Devices.Catalog.KioskExecutionEndpoint", "KioskExecutionEndpoint")
                        .WithMany()
                        .HasForeignKey("KioskExecutionEndpointId", "KioskId", "EdgeRuntimeId")
                        .HasPrincipalKey("Id", "KioskId", "FullEdgeRuntimeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Sync.Entities.EdgeCommand", b =>
                {
                    b.HasOne("Domain.Devices.Catalog.KioskExecutionEndpoint", "TargetExecutionEndpoint")
                        .WithMany()
