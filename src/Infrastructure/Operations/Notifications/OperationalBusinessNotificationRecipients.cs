...
public static class OperationalBusinessNotificationRecipients
{
    public static async Task<IReadOnlyCollection<Guid>> ListAsync(
    ...
    {
        var eligibleRoles = dbContext.AccountRoles.AsNoTracking().Where(accountRole =>
