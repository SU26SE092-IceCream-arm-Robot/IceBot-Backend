...
public interface IConfigurationReleaseStore
{
    ...
    Task<ConfigurationReleaseAuthoringOptionsReadModel> GetAuthoringOptionsAsync(Guid organizationId, Guid? productVariantId,
        string? search, bool includeGlobalTemplates, int limit, CancellationToken cancellationToken = default);
