...
public static class ScopeRoleSets
{
    ...
    public static readonly string[] KiosksView = ["SystemAdmin", "OrgAdmin", "Manager", "Staff", "Technician"];
    ...
    public static readonly string[] MenuItemAvailabilityManage = ["SystemAdmin", "OrgAdmin", "Manager", "Staff"];
    ...
    public static readonly string[] OrdersView = ["OrgAdmin", "Manager", "Staff"];
